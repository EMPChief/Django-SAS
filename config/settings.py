...
STRIPE_LIVE_SECRET_KEY = os.environ.get(
    "STRIPE_API_SECRET_LIVE", "<default-live-secret-key>")
STRIPE_TEST_SECRET_KEY = os.environ.get(
    "STRIPE_API_SECRET_TEST", "<default-test-secret-key>")
STRIPE_LIVE_MODE = True
# Get it from the s ection in the Stripe dashboard where you added the webhook endpoint
